...
<html class=" ">
    <head>
        ...
        <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - START form _calonanak--> 
        <link href="assets/plugins/icheck/skins/all.css" rel="stylesheet" type="text/css" media="screen"/> 
         <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - END --> 


        <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - START  tabel_anak--> 
    ...
    <body class=" ">
                ...
                <div class="page-sidebar-wrapper" id="main-menu-wrapper"> 
                    ...
                    <ul class='wraplist'>   
                        ...
                        <li class=""> 
                            <a href="form_anak">
                                <i class="fa fa-th"></i>
                                <span class="title">Form Anak</span><span class="label label-orange nosubmenu">HOT</span>
                            </a>
                        </li>
                        ...
                        <li class=""> 
                            ...
                            <ul class="sub-menu" >
                                <li>
                                    <a class="" href="tabel_calonanak">Tabel Calon Anak Asuh</a>
                                </li>
                                <li>
                                    <a class="" href="tabel_anakasuh">Tabel Anak Asuh</a>
                                </li>
                                <li>
                                    <a class="" href="tabel_donatur">Tabel Donatur</a>
                                </li>
                            </ul>
                        </li>
                        <li class=""> 
        ...
        <!-- OTHER SCRIPTS INCLUDED ON THIS PAGE - START form_calonanak --> 
