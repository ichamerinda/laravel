...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Login LPUQ Jombang</title>
        ...
        <div class="login-wrapper">
            <div id="login" class="login loginpage col-lg-offset-4 col-lg-4 col-md-offset-3 col-md-6 col-sm-offset-3 col-sm-6 col-xs-offset-2 col-xs-8">
                ...
                <form name="loginform" id="loginform" action="auth/login" method="post">
                    ...
                    <p class="forgetmenot">
                        <label class="icheck-label form-label" for="rememberme"><input name="remember" type="checkbox" id="remember" value="forever" class="skin-square-orange" checked> Remember me</label>
                    </p>

                    <a href="home2">
                    <p class="submit">
                        <input type="submit" name="wp-submit" id="submit" class="btn btn-orange btn-block" value="Sign In" />
                    </p></a>
                </form>
